...
Сам результат остаётся в системе, которой он принадлежит: пост — на площадке публикации, карточка клиента — в CRM, документ — в проекте. Запись задачи хранит ссылку на результат, а не его копию.
