...
Правила лежат в каждой папке. Запускаю агента из штаба, он видит карту всей системы. Запускаю из отдела, видит свой домен, свои задачи и свои скиллы. Модель одна, представление разное. Задаёт его папка, а длинный промпт для этого не нужен.
